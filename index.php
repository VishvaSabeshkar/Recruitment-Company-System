...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="./homepage/css/header-footer.css">
        <link rel="stylesheet" type="text/css" href="./homepage/css/styles.css"> <!-- Only for homepage -->
        <link rel="stylesheet" type="text/css" href="./homepage/css/cards.css">
    ...
    <body>
        ...
        <div class="header">
            <div class="left">
                <a class="logo-home" href="index.php"><h1 class="site-name">Hire Gateway</h1></a>
            </div>
            <div class="middle">
                <nav class="nav">
                    <ul>
            ...
            <div class="right">
                <button class="sign-up"><a href="./signin-signup/signin/sign-in.php">Sign In</a></button>
                <button class="sign-in"><a href="./signin-signup/signup/sign-up.php">Sign Up</a></button>
                ...
                <?php
                    ...
                    while($row=mysqli_fetch_array($data)){
                        ...
                        <div class="box">
                            ...
                            <button class="btn" onclick="showApplyMessage()"><a  href="#">Apply Now</a>
                        </div>
        ...
        <script>
            function showApplyMessage() {
                alert("If you want to apply for a job please signin as an applicant");
            }
        </script>
    </body>
</html>